...
/*FCT_ASM( caller_ReceivedSaveFilesToSave_114_2 )
  PUSH EAX
  PUSH EAX
  ...
  POP EAX
  JE continue_rcvFct
  MOV DWORD PTR SS : [ESP], 0x44C711
  RETN
continue_rcvFct :
  MOVZX ECX, BYTE PTR SS : [EAX]
  LEA EDX, DWORD PTR DS : [ECX - 0xAF]
  RETN
}}*/
...
void Install_SavePlayerData()
{
  ...
  /*if (version_D2Game == V114d) {
    ...
    memt_byte(0xBD, 0xE8);
    MEMT_REF4(0xFFFFDFF8, caller_SendSaveFilesToSave_114);
  }
  else {*/
    memt_byte(0x8B, 0x90); // NOP
  ...
  /*if (version_D2Game == V114d) {
    memt_byte(0x83, 0x90);
    memt_byte(0xB9, 0xE8);
    MEMT_REF4(0x0000017C, caller_ManageNextPacketToSend_114);
    memt_byte(0x00, 0x90);
  }
  else {*/
    memt_byte(0x8B, 0x90); // NOP
...
//	MEMT_REF4( (version_D2Game == V110) ?  0x50CD8BD3 : 0x50CF8BD3, (version_D2Game == V110) ? caller_SendSaveFilesToSave : caller_SendSaveFilesToSave_9);
  ...
  if (version_D2Game == V114d) {
    ...
    MEMT_REF4(0x0001013F, caller_ReceivedSaveFilesToSave_114);

    //mem_seek R8(D2Client, 116F0, 116E0, 11CB0, 89246, 32076, 7BCD6, 43946, 448E6, 4C70D);
    //MEMT_REF4(0x0001013F, caller_ReceivedSaveFilesToSave_114_2);

    //mem_seek R8(D2Client, 116F0, 116E0, 11CB0, 89246, 32076, 7BCD6, 43946, 448E6, 5C857);
    //memt_byte(0x0F, 0xE8);
    //MEMT_REF4(0x918D08B6, caller_ReceivedSaveFilesToSave_114_2);
    //memt_dword(0xFFFFFF51, 0x90909090);
